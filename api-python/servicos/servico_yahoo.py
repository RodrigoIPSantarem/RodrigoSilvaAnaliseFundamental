...
class ServicoYahoo:
    ...
    def obter_taxa_livre_risco() -> float:
        ...
        try:
            ...
            # Erro silencioso, retorna fallback
            return 0.045  # 4.5%
    ...
    def obter_dados_acao(ticker_simbolo: str) -> dict:
        ...
        try:
            ...
            # 2. Kill Switch: Margens em Queda
            ...
            if ebitda != 0:
                ...
                divida_ebitda = (float(info['debtToEquity']) / 100.0) * 2
            ...
            return {
                ...
                "dadosFinanceiros": {
                    ...
                    # CORREÇÃO CRÍTICA: Limitar crescimento a 25% (0.25)
                    "crescimentoReceita5A": min(float(info.get('revenueGrowth', 0.05) or 0.05), 0.25),
                    "crescimentoLucros5A": min(float(info.get('earningsGrowth', 0.05) or 0.05), 0.25),
